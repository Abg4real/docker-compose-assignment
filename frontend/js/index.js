...
async function headlines() {
    addLoading();
    current = 'Headlines'
    //const results = await fetch(`https://newsapi.org/v2/top-headlines?country=in&page=${pageNo}&apiKey=f662f9435c314ef3bc7b0d06f3b0441b`);
    const results = await fetch('http://localhost:3001/api/top-headlines');
    if (!results.ok) {
...
async function searchResults() {
    ...
    const url = `http://localhost:3001/api/search?q=${keyword}`;
